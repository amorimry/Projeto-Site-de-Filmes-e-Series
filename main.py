...
lista_filmes_assistidos = [
    Filme("Interestelar", 2014, 169, "Ficção Científica",
          "Astronautas viajam pelo espaço em busca de um novo lar para a humanidade.", True),

    Filme("Clube da Luta", 1999, 139, "Drama",
          "Um homem insatisfeito cria um clube secreto de lutas.", True),

    Filme("Vingadores: Ultimato", 2019, 181, "Ação",
          "Os heróis enfrentam Thanos em sua batalha final.", True),

    Filme("O Rei Leão", 1994, 88, "Animação",
          "Simba enfrenta desafios para assumir o trono.", True),

    Filme("Matrix", 1999, 136, "Ficção Científica",
          "Um programador descobre que vive em uma simulação.", True)
]
lista_filmes_nao_assistidos = [
    Filme("Oppenheimer", 2023, 180, "Drama",
          "A história do criador da bomba atômica.", False),

    Filme("Duna: Parte Dois", 2024, 166, "Ficção Científica",
          "Paul Atreides continua sua jornada em Arrakis.", False),

    Filme("Parasita", 2019, 132, "Suspense",
          "Uma família pobre se infiltra na vida de uma família rica.", False),

    Filme("Blade Runner 2049", 2017, 164, "Ficção Científica",
          "Um novo blade runner descobre um segredo perigoso.", False),

    Filme("Whiplash", 2014, 107, "Drama",
          "Um jovem baterista busca a perfeição.", False)
]

lista_series_assistidas = [
    Serie("Breaking Bad", 2008, 5, "Drama",
          "Um professor de química entra para o tráfico de drogas.", True),

    Serie("Dark", 2017, 3, "Ficção Científica",
          "Mistérios envolvendo viagens no tempo.", True),

    Serie("Stranger Things", 2016, 5, "Suspense",
          "Crianças enfrentam criaturas de outra dimensão.", True),

    Serie("The Office", 2005, 9, "Comédia",
          "O cotidiano de um escritório cheio de situações engraçadas.", True),

    Serie("Arcane", 2021, 2, "Animação",
          "Conflitos entre Piltover e Zaun.", True)
]
lista_series_nao_assistidas = [
    Serie("The Last of Us", 2023, 2, "Drama",
          "Sobreviventes enfrentam um mundo devastado por um fungo.", False),

    Serie("House of the Dragon", 2022, 2, "Fantasia",
          "A guerra civil da Casa Targaryen.", False),

    Serie("Severance", 2022, 2, "Suspense",
          "Funcionários têm suas memórias divididas entre trabalho e vida pessoal.", False),

    Serie("The Bear", 2022, 4, "Drama",
          "Um chef tenta salvar o restaurante da família.", False),

    Serie("One Piece", 1999, 22, "Anime",
